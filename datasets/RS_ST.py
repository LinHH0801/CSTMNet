...
ST_COLORMAP2 = [[0, 0,0], [255, 0, 0],[0, 255, 0],[0 ,0, 255]]
...
def Index2Color(pred):
    ...
    return colormap[x, :]
def Index2Color_multi(pred):
    colormap = np.asarray(ST_COLORMAP2, dtype='uint8')
    x = np.asarray(pred, dtype='int32')
    return colormap[x, :]
...
class Data_test(data.Dataset):
    def __init__(self, test_dir):
        ...
        # img_4_dir = os.path.join(test_dir, '2022')
